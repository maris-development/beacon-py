...
class BaseQuery(metaclass=abc.ABCMeta):
    ...
    def to_arrow_stream(self, force: bool = False) -> pa.RecordBatchStreamReader: ...
    def to_arrow_table(self, force: bool = False) -> pa.Table: ...
    ...
    def to_pandas_dataframe(self, force: bool = False) -> pd.DataFrame: ...
